...
int main() {
  ...
  ParticleFilter pf;
  std::cout<<"before init"<<pf.initialized()<<std::endl;
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (!pf.initialized()) {
            ...
            std::cout<<"after init"<<pf.initialized()<<std::endl;
          ...
          //std::cout<<"w before"<<pf.particles[100].weight<<std::endl;
          ...
          std::cout << "highest w " << highest_weight <<"  "<<"10th particle weight"<<pf.particles[10].weight <<std::endl;
          std::cout << "average w " << weight_sum/num_particles << std::endl;
          std::cout <<pf.getAssociations(pf.particles[10])<<std::endl;
          std::cout <<pf.getSenseCoord(pf.particles[10],"X")<<std::endl;
          std::cout <<pf.getSenseCoord(pf.particles[10],"Y")<<std::endl<<"\n\n";
